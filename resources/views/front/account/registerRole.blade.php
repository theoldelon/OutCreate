                                            ...
                                            <div class="card border-0 p-3 shadow mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-grid mt-3">
                                                        <a href="{{ route('account.registration', ['role' => 'client']) }}" class="btn btn-primary btn-lg">Register</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            <div class="card border-0 p-3 shadow mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-grid mt-3">
                                                        <a href="{{ route('account.registration', ['role' => 'freelancer']) }}" class="btn btn-primary btn-lg">Register</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

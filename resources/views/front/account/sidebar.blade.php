...
<div class="bg-white shadow rounded p-4">
    ...
    <ul class="bg-white">
        ...
        <li>
            <a href="{{ route('account.show', ['id' => Auth::user()->id]) }}" class="flex items-center justify-between w-full p-2 text-gray-700 hover:bg-blue-200 rounded transition duration-200 no-underline">

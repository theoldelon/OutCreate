                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="authDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            {{ Auth::check() ? 'Account' : 'Login / Register' }}
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="authDropdown">
                            ...
                            @else
                                ...
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <i class="fas fa-envelope"></i> Inbox <span class="badge bg-danger"></span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item text-danger" type="button" data-bs-toggle="modal" data-bs-target="#logoutModal">
